...
const page = () => {
  return (
    <div>
        <h1 className='text-center underline font-bold text-3xl'>Honda City 2024 Price in Pakistan, Images, Reviews & <br /> Specs</h1> 

    <div className="flex justify-center items-center mt-10">

        <Image className="w-80 h-[215]" src={"/honda.png"} width={133} height={1} alt=""/>
    </div>
    ...
    <div>
      <p className="text-center text-green-700 text-2xl mt-5">PKR 50,00,00</p>
    </div>
